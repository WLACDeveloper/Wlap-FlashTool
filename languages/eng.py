...
CHANGELIST = 'Final Release\n-Added function select\n partition for recovery\n-Themes Rebuild\n-Language fix'
SelectRecoveryPart = 'Select partition for flash Recovery image'
apps = 'About us'
buildwalm = 'Builded on WALMFast'
folderSelect = 'Select Folder'
changelist = 'Changelog'
updatebutt = '                                                   Update                                                 '
aboutpr = 'About program'
codename = 'Codename:'
numberBuild = 'Program version:'
CoreNumber = 'Core version:'
